...
exports.defaultSuggestionsFilter = exports.getSearchText = undefined;
...
var createCompletionPlugin = function createCompletionPlugin(completionSuggestionsStrategy, addModifier, SuggestionEntry) {
  ...
  return function () {
    ...
    return {
      ...
      onDownArrow: function onDownArrow(event) {
        return callbacks.onDownArrow && callbacks.onDownArrow(event);
      },
      onTab: function onTab(event) {
        return callbacks.onTab && callbacks.onTab(event);
      },
      onUpArrow: function onUpArrow(event) {
        return callbacks.onUpArrow && callbacks.onUpArrow(event);
      },
      onEscape: function onEscape(event) {
        return callbacks.onEscape && callbacks.onEscape(event);
      },
      handleReturn: function handleReturn(event) {
        return callbacks.handleReturn && callbacks.handleReturn(event);
      },
...
exports.getSearchText = _getSearchText2.default;
